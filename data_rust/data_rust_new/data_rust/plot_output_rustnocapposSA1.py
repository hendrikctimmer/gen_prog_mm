...
for y in range(42):
	...
	f = open("5mat" + "nocapposSA1-" + str(y+1), "r")
	lines = f.readlines()
...
for y in range(42):
	...
	f = open("10mat" + "nocapposSA1-" + str(y+1), "r")
	lines = f.readlines()
...
for y in range(42):
	...
	f = open("15mat" + "nocapposSA1-" + str(y+1), "r")
	lines = f.readlines()
...
for y in range(42):
	...
	f = open("20mat" + "nocapposSA1-" + str(y+1), "r")
	lines = f.readlines()
...
for y in range(42):
	...
	f = open("25mat" + "nocapposSA1-" + str(y+1), "r")
	lines = f.readlines()
...
plt.title("Cell difference over generations, NocapPos SA alpha = 0.1")
