...
for y in range(42):
	...
	f = open("5mat" + "nocapposSA3-" + str(y+1), "r")
	lines = f.readlines()
...
for y in range(42):
	...
	f = open("10mat" + "nocapposSA3-" + str(y+1), "r")
	lines = f.readlines()
...
for y in range(42):
	...
	f = open("15mat" + "nocapposSA3-" + str(y+1), "r")
	lines = f.readlines()
...
for y in range(42):
	...
	f = open("20mat" + "nocapposSA3-" + str(y+1), "r")
	lines = f.readlines()
...
for y in range(42):
	...
	f = open("25mat" + "nocapposSA3-" + str(y+1), "r")
	lines = f.readlines()
...
plt.title("Cell difference over generations, NocapPos SA alpha = 0.001")
