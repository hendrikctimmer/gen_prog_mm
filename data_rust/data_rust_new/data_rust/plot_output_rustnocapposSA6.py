...
for y in range(42):
	...
	f = open("5mat" + "nocapposSA6-" + str(y+1), "r")
	lines = f.readlines()
...
for y in range(42):
	...
	f = open("10mat" + "nocapposSA6-" + str(y+1), "r")
	lines = f.readlines()
...
for y in range(42):
	...
	f = open("15mat" + "nocapposSA6-" + str(y+1), "r")
	lines = f.readlines()
...
for y in range(42):
	...
	f = open("20mat" + "nocapposSA6-" + str(y+1), "r")
	lines = f.readlines()
...
for y in range(42):
	...
	f = open("25mat" + "nocapposSA6-" + str(y+1), "r")
	lines = f.readlines()
...
plt.title("Cell difference over generations, NocapPos SA alpha = 0.000001")
...
plt.title("Vertical axis shift vs. problem instances NoCapPos")
print(params)
plt.show()
#print(gens[1])
#print(run1_diff[1])
