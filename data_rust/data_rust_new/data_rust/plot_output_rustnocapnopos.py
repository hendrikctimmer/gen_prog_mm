...
for y in range(248):
	...
	f = open("5mat" + "nocapnopos" + str(y+1), "r")
	lines = f.readlines()
...
for y in range(248):
	...
	f = open("15mat" + "nocapnopos" + str(y+1), "r")
	lines = f.readlines()
...
for y in range(248):
	...
	f = open("20mat" + "nocapnopos" + str(y+1), "r")
	lines = f.readlines()
...
for y in range(248):
	...
	f = open("25mat" + "nocapnopos" + str(y+1), "r")
	lines = f.readlines()
...
for y in range(248):
	...
	f = open("30mat" + "nocapnopos" + str(y+1), "r")
	lines = f.readlines()
...
plt.title("Cell difference over generations, NocapNopos")
...
plt.title("Vertical axis shift vs. problem instances NoCapNoPos")
print(params)
plt.show()
#print(gens[1])
#print(run1_diff[1])
