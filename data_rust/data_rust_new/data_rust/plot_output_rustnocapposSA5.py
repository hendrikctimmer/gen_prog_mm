...
for y in range(42):
	...
	f = open("5mat" + "nocapposSA5-" + str(y+1), "r")
	lines = f.readlines()
...
for y in range(42):
	...
	f = open("10mat" + "nocapposSA5-" + str(y+1), "r")
	lines = f.readlines()
...
for y in range(42):
	...
	f = open("15mat" + "nocapposSA5-" + str(y+1), "r")
	lines = f.readlines()
...
for y in range(42):
	...
	f = open("20mat" + "nocapposSA5-" + str(y+1), "r")
	lines = f.readlines()
...
for y in range(42):
	...
	f = open("25mat" + "nocapposSA5-" + str(y+1), "r")
	lines = f.readlines()
...
plt.title("Cell difference over generations, NocapPos SA alpha = 0.00001")
