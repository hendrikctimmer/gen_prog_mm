...
for y in range(42):
	...
	f = open("5mat" + "nocapposSA4-" + str(y+1), "r")
	lines = f.readlines()
...
for y in range(42):
	...
	f = open("10mat" + "nocapposSA4-" + str(y+1), "r")
	lines = f.readlines()
...
for y in range(42):
	...
	f = open("15mat" + "nocapposSA4-" + str(y+1), "r")
	lines = f.readlines()
...
for y in range(42):
	...
	f = open("20mat" + "nocapposSA4-" + str(y+1), "r")
	lines = f.readlines()
...
for y in range(42):
	...
	f = open("25mat" + "nocapposSA4-" + str(y+1), "r")
	lines = f.readlines()
...
plt.title("Cell difference over generations, NocapPos SA alpha = 0.0001")
