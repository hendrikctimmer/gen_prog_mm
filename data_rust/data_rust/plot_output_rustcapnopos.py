...
for y in range(248):
	...
	f = open("5mat" + "capnopos" + str(y+1), "r")
	lines = f.readlines()
...
for y in range(248):
	...
	f = open("15mat" + "capnopos" + str(y+1), "r")
	lines = f.readlines()
...
for y in range(10):
	...
	f = open("20mat" + "capnopos" + str(y+1), "r")
	lines = f.readlines()
...
for y in range(248):
	...
	f = open("25mat" + "capnopos" + str(y+1), "r")
	lines = f.readlines()
...
for y in range(248):
	...
	f = open("30mat" + "capnopos" + str(y+1), "r")
	lines = f.readlines()
...
plt.title("Cell difference over generations, CapNopos")
...
plt.plot(matrices, final_func(matrices, params[0], params[1], params[2]), ls='--')
plt.xlim([0,40])
plt.ylim([0,80])
print(params)
plt.show()
