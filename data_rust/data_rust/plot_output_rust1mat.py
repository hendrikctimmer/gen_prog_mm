...
for y in range(10):
	...
	f = open("1mat" + "nocappos" + str(y+1), "r")
	lines = f.readlines()
...
for y in range(10):
	...
	f = open("1mat" + "capnopos" + str(y+1), "r")
	lines = f.readlines()
...
for y in range(10):
	...
	f = open("1mat" + "nocapnopos" + str(y+1), "r")
	print("1matnocapnopos" + str(y+1))
	lines = f.readlines()
...
plt.title("Cell difference over generations, 1 matrix triple")
