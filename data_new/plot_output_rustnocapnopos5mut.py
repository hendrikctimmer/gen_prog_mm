...
for y in range(10):
	...
	f = open("5mat" + "nocapnopos5mut" + str(y+1), "r")
	lines = f.readlines()
...
for y in range(10):
	...
	f = open("10mat" + "nocapnopos5mut" + str(y+1), "r")
	lines = f.readlines()
...
for y in range(10):
	...
	f = open("15mat" + "nocapnopos5mut" + str(y+1), "r")
	lines = f.readlines()
...
for y in range(10):
	...
	f = open("20mat" + "nocapnopos5mut" + str(y+1), "r")
	lines = f.readlines()
...
for y in range(10):
	...
	f = open("25mat" + "nocapnopos5mut" + str(y+1), "r")
	lines = f.readlines()
...
for y in range(10):
	...
	f = open("30mat" + "nocapnopos5mut" + str(y+1), "r")
	lines = f.readlines()
...
plt.text(40000,94, "NoCapEQ", fontsize=12,bbox=dict(facecolor='none', alpha=0.5))
