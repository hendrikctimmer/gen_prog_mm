...
plt.xlabel("No. Generations", fontsize = 11)
plt.ylabel("Average cell difference", fontsize = 11)
plt.text(40000,94, "CapEQ", fontsize=13,bbox=dict(facecolor='none', alpha=0.5))
