...
for y in range(10):
	...
	f = open("5mat" + "capnopos" + str(no_muts) + "mut" + str(y+1), "r")
	lines = f.readlines()
...
for y in range(10):
	...
	f = open("10mat" + "capnopos" + str(no_muts) + "mut" + str(y+1), "r")
	lines = f.readlines()
...
for y in range(10):
	...
	f = open("15mat" + "capnopos" + str(no_muts) + "mut" + str(y+1), "r")
	lines = f.readlines()
...
for y in range(10):
	...
	f = open("20mat" + "capnopos" + str(no_muts) + "mut" + str(y+1), "r")
	lines = f.readlines()
...
for y in range(10):
	...
	f = open("25mat" + "capnopos" + str(no_muts) + "mut" + str(y+1), "r")
	lines = f.readlines()
...
for y in range(10):
	...
	f = open("30mat" + "capnopos" + str(no_muts) + "mut" + str(y+1), "r")
	lines = f.readlines()
...
plt.ylabel("No. Incorrect Cells", fontsize = 12)
plt.text(40000,22.15, "CapEQ", fontsize=12,bbox=dict(facecolor='#c4c3c2', alpha=1))
plt.subplots_adjust(right = 0.57, top = 0.98, bottom = 0.09)
plt.legend(title="Instances", reverse= True, fontsize = 11)
