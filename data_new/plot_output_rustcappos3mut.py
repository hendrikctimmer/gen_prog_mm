...
for y in range(10):
	...
	f = open("5mat" + "cappos3mut" + str(y+1), "r")
	lines = f.readlines()
...
for y in range(10):
	...
	f = open("10mat" + "cappos3mut" + str(y+1), "r")
	lines = f.readlines()
...
for y in range(10):
	...
	f = open("15mat" + "cappos3mut" + str(y+1), "r")
	lines = f.readlines()
...
for y in range(10):
	...
	f = open("20mat" + "cappos3mut" + str(y+1), "r")
	lines = f.readlines()
...
for y in range(10):
	...
	f = open("25mat" + "cappos3mut" + str(y+1), "r")
	lines = f.readlines()
...
for y in range(10):
	...
	f = open("30mat" + "cappos3mut" + str(y+1), "r")
	lines = f.readlines()
...
plt.text(40000,94, "CapNoEQ", fontsize=12,bbox=dict(facecolor='none', alpha=0.5))
