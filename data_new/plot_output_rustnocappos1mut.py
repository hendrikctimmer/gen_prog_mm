...
for y in range(10):
	...
	f = open("5mat" + "nocappos1mut" + str(y+1), "r")
	lines = f.readlines()
...
for y in range(10):
	...
	f = open("10mat" + "nocappos1mut" + str(y+1), "r")
	lines = f.readlines()
...
for y in range(10):
	...
	f = open("15mat" + "nocappos1mut" + str(y+1), "r")
	lines = f.readlines()
...
for y in range(10):
	...
	f = open("20mat" + "nocappos1mut" + str(y+1), "r")
	lines = f.readlines()
...
for y in range(10):
	...
	f = open("25mat" + "nocappos1mut" + str(y+1), "r")
	lines = f.readlines()
...
for y in range(10):
	...
	f = open("30mat" + "nocappos1mut" + str(y+1), "r")
	lines = f.readlines()
