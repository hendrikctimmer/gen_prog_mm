...
for y in range(10):
	...
	f = open("5mat" + "capnopos3mut" + str(y+1), "r")
	lines = f.readlines()
...
for y in range(10):
	...
	f = open("10mat" + "capnopos3mut" + str(y+1), "r")
	lines = f.readlines()
...
for y in range(10):
	...
	f = open("15mat" + "capnopos3mut" + str(y+1), "r")
	lines = f.readlines()
...
for y in range(10):
	...
	f = open("20mat" + "capnopos3mut" + str(y+1), "r")
	lines = f.readlines()
...
for y in range(10):
	...
	f = open("25mat" + "capnopos3mut" + str(y+1), "r")
	lines = f.readlines()
...
for y in range(10):
	...
	f = open("30mat" + "capnopos3mut" + str(y+1), "r")
	lines = f.readlines()
