...
for y in range(10):
	...
	f = open("5mat" + "capnopos4mut" + str(y+1), "r")
	lines = f.readlines()
...
for y in range(10):
	...
	f = open("10mat" + "capnopos4mut" + str(y+1), "r")
	lines = f.readlines()
...
for y in range(10):
	...
	f = open("15mat" + "capnopos4mut" + str(y+1), "r")
	lines = f.readlines()
...
for y in range(10):
	...
	f = open("20mat" + "capnopos4mut" + str(y+1), "r")
	lines = f.readlines()
...
for y in range(10):
	...
	f = open("25mat" + "capnopos4mut" + str(y+1), "r")
	lines = f.readlines()
...
for y in range(10):
	...
	f = open("30mat" + "capnopos4mut" + str(y+1), "r")
	lines = f.readlines()
...
plt.text(40000,94, "CapEQ", fontsize=12,bbox=dict(facecolor='none', alpha=0.5))
