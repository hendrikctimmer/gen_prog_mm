...
for y in range(10):
	...
	f = open("5mat" + "nocapnopos" + str(no_muts) + "mut" + str(y+1), "r")
	lines = f.readlines()
...
for y in range(10):
	...
	f = open("10mat" + "nocapnopos" + str(no_muts) + "mut" + str(y+1), "r")
	lines = f.readlines()
...
for y in range(10):
	...
	f = open("15mat" + "nocapnopos" + str(no_muts) + "mut" + str(y+1), "r")
	lines = f.readlines()
...
for y in range(10):
	...
	f = open("20mat" + "nocapnopos" + str(no_muts) + "mut" + str(y+1), "r")
	lines = f.readlines()
...
for y in range(10):
	...
	f = open("25mat" + "nocapnopos" + str(no_muts) + "mut" + str(y+1), "r")
	lines = f.readlines()
...
for y in range(10):
	...
	f = open("30mat" + "nocapnopos" + str(no_muts) + "mut" + str(y+1), "r")
	lines = f.readlines()
...
plt.title("Cell difference over generations, NocapNoGreedy")
...
plt.text(40000,20.2, "NoCapEQ", fontsize=12,bbox=dict(facecolor='none', alpha=0.5))
...
plt.title("Vertical axis shift vs. problem instances NoCapNoGreedy")
plt.legend()
print(params)
#plt.show()
#print(gens[1])
