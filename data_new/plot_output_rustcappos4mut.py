...
for y in range(10):
	...
	f = open("10mat" + "cappos4mut" + str(y+1), "r")
	lines = f.readlines()
...
for y in range(10):
	...
	f = open("15mat" + "cappos4mut" + str(y+1), "r")
	lines = f.readlines()
...
for y in range(10):
	...
	f = open("20mat" + "cappos4mut" + str(y+1), "r")
	lines = f.readlines()
...
for y in range(10):
	...
	f = open("25mat" + "cappos4mut" + str(y+1), "r")
	lines = f.readlines()
...
for y in range(10):
	...
	f = open("30mat" + "cappos4mut" + str(y+1), "r")
	lines = f.readlines()
