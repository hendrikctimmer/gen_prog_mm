...
for y in range(10):
	...
	f = open("5mat" + "nocappos3mut" + str(y+1), "r")
	lines = f.readlines()
...
for y in range(10):
	...
	f = open("10mat" + "nocappos3mut" + str(y+1), "r")
	lines = f.readlines()
...
for y in range(10):
	...
	f = open("15mat" + "nocappos3mut" + str(y+1), "r")
	lines = f.readlines()
...
for y in range(10):
	...
	f = open("20mat" + "nocappos3mut" + str(y+1), "r")
	lines = f.readlines()
...
for y in range(10):
	...
	f = open("25mat" + "nocappos3mut" + str(y+1), "r")
	lines = f.readlines()
...
for y in range(10):
	...
	f = open("30mat" + "nocappos3mut" + str(y+1), "r")
	lines = f.readlines()
...
plt.text(40000,94, "NoCapNoEQ", fontsize=12,bbox=dict(facecolor='none', alpha=0.5))
