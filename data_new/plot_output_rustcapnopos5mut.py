...
for y in range(10):
	...
	f = open("5mat" + "capnopos5mut" + str(y+1), "r")
	lines = f.readlines()
...
for y in range(10):
	...
	f = open("10mat" + "capnopos5mut" + str(y+1), "r")
	lines = f.readlines()
...
for y in range(10):
	...
	f = open("15mat" + "capnopos5mut" + str(y+1), "r")
	lines = f.readlines()
...
for y in range(10):
	...
	f = open("20mat" + "capnopos5mut" + str(y+1), "r")
	lines = f.readlines()
...
for y in range(10):
	...
	f = open("25mat" + "capnopos5mut" + str(y+1), "r")
	lines = f.readlines()
...
for y in range(10):
	...
	f = open("30mat" + "capnopos5mut" + str(y+1), "r")
	lines = f.readlines()
