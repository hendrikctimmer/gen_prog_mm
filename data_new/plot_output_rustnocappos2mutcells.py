...
for y in range(10):
	...
	f = open("5mat" + "nocappos" + str(no_muts) + "mut" + str(y+1), "r")
	lines = f.readlines()
...
for y in range(10):
	...
	f = open("10mat" + "nocappos" + str(no_muts) + "mut" + str(y+1), "r")
	lines = f.readlines()
...
for y in range(10):
	...
	f = open("15mat" + "nocappos" + str(no_muts) + "mut" + str(y+1), "r")
	lines = f.readlines()
...
for y in range(10):
	...
	f = open("20mat" + "nocappos" + str(no_muts) + "mut" + str(y+1), "r")
	lines = f.readlines()
...
for y in range(10):
	...
	f = open("25mat" + "nocappos" + str(no_muts) + "mut" + str(y+1), "r")
	lines = f.readlines()
...
for y in range(10):
	...
	f = open("30mat" + "nocappos" + str(no_muts) + "mut" + str(y+1), "r")
	lines = f.readlines()
...
plt.title("Cell difference over generations, NocapGreedy")
...
plt.text(40000,20.2, "NoCapNoEQ", fontsize=12,bbox=dict(facecolor='none', alpha=0.5))
...
plt.title("Vertical axis shift vs. problem instances NoCapGreedy")
plt.tick_params(labelleft=False)
plt.legend()
print(params)
#plt.show()
